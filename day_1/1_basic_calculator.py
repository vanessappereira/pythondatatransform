...
def basicOperators(option):
    ...
    while True:
        ...
        if option.lower() == "a":
            ...
            print(
                f"The result of the addition between {firstValue} and {secondValue} is: {sumResult}."
            )
            break
            ...
            print(
                f"The result of the subtraction between {firstValue} and {secondValue} is: {subResult}."
            )
            break
            ...
            print(
                f"The result of the multiplication between {firstValue} and {secondValue} is: {multiResult} "
            )
            break
            ...
            if secondValue != 0:
                ...
                print(
                    f"The division between {firstValue} and {secondValue} is: {divResult}"
                )
            else:
